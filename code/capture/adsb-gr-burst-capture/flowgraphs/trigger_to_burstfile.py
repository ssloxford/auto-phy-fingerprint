...
class trigger_to_burstfile(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "trigger_to_burstfile")
        ...
        self.burstfile_BurstfileWriter_0 = burstfile.BurstfileWriter('/radio/burstfile.sdrbf')
        ...
        self.connect((self.triggers_DoubleSlidingWindowTrigger_0, 0), (self.qtgui_time_sink_x_0_0, 0))
...
def main(top_block_cls=trigger_to_burstfile, options=None):
